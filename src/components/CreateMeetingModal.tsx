...
export default function CreateMeetingModal({ isOpen, onClose, onCreated, classId }: CreateMeetingModalProps) {
  ...
  const generateGMeetLink = () => {
    // Basic generator for simulation/convenience
      ...
      <div className="w-full max-w-2xl bg-surface rounded-[40px] shadow-3xl overflow-hidden border border-white/20">
        <div className="p-8 border-b border-on-surface/5 flex justify-between items-center bg-white/60">
          <div className="flex items-center gap-3">
             ...
             <h3 className="text-2xl font-black italic tracking-tight text-secondary">Jadwalkan Meeting</h3>
          </div>
